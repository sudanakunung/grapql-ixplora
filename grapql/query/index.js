...
const { following_post, near_post } = require("../resolver/explore");
const {
  GraphQLObjectType,
  GraphQLID,
  GraphQLList,
...
module.exports = new GraphQLObjectType({
  ...
  fields: {
    ...
    near_post: {
      ...
      resolve(parent, args) {
        return near_post(args.auth, args.longitude,args.latitude,args.limit,args.offset);
      },
    },
    following_post: {
      type: GraphQLList(require("../type/post")),
      ...
      resolve(parent, args) {
        return following_post(args.auth);
      },
    },
  },
});